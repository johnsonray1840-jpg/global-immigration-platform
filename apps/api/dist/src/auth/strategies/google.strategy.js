...
let GoogleStrategy = class GoogleStrategy extends (0, passport_1.PassportStrategy)(passport_google_oauth20_1.Strategy, 'google') {
    ...
    constructor(configService, prisma) {
        const clientID = configService.get('GOOGLE_CLIENT_ID') || 'google-client-id-placeholder';
        const clientSecret = configService.get('GOOGLE_CLIENT_SECRET') || 'google-client-secret-placeholder';
